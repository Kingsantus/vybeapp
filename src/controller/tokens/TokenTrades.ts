...
const getTokenTrades = async (programId?: string, resolution?: range, limit?: number, baseMintAddress?: string, quoteMintAddress?: string, marketId?: string, authorityAddress?: string):Promise<any> => {
    try {
